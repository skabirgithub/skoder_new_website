        ...
        <form method="post" action="<?php echo e(route('LaravelInstaller::licenseCheck')); ?>" class="tabs-wrap">
            ...
            <div>
                ...
                <div class="form-group <?php echo e($errors->has('username') ? ' has-error ' : ''); ?>">
                    ...
                    <input type="text" name="username" id="username" value="babiato.co/ghostriderrr" placeholder="Username of Your Envato Account" />
                ...
                <div class="form-group <?php echo e($errors->has('purchase_code') ? ' has-error ' : ''); ?>">
                    <label for="purchase_code">
                        Purchase Code <span style="color:red">Nulled and Shared on babiato.co </span>
                    </label>
                    <input type="text" name="purchase_code" id="purchase_code" value="babiato.co/ghostriderrr" placeholder="Your Item Purchase Code" />
...
<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/skodr/public_html/core/resources/views/vendor/installer/license.blade.php ENDPATH**/ ?>